...
#**************************************************
function path_append {
    eval `${HOME}/util/paths/path_modify_base -mode append -name PATH $* `
}
...
#**************************************************
function path_prepend {
    eval `${HOME}/util/paths/path_modify_base -mode prepend -name PATH $* `
}
...
#**************************************************
function path_insert {
    eval `${HOME}/util/paths/path_modify_base -mode insert -name PATH $* `
}
...
#**************************************************
function path_dominant {
    eval `${HOME}/util/paths/path_modify_base -mode dominant -name PATH $*`
}